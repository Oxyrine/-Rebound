...
28 of 59 shared cases diverged. Safer arm: {'llm_all': 24, 'rules_all': 4}
...
| RCV-028 | NEAR_MISS | False | RECOVER | STOP | rules_all | — | Okay, நான் pay பண்ணுறேன் தெரியும், but I don't want to stop the subscription. S… |
...
59 evaluated -> 25 eligible -> 25 link attempts -> 0 created -> 0 completed
Completed Test Mode value: ₹0.00 (execution proof, not commercial impact)

=== Safety outcomes ===
STOPPED: 15   PAUSED: 2   HUMAN REVIEW: 17   NO ACTION: 25
